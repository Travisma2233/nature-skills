---
name: nature-paper-writing
description: Improve Nature-family research paper writing with section-specific structure, paragraph flow, reviewer-facing claims, and evidence checks. Use when drafting or revising Abstract, Introduction, Related Work, Method, Experiments, or Conclusion; polishing figures/tables; checking claim-support alignment; or performing final manuscript self-review.
---
